      ...
      <nav className="container relative flex flex-wrap items-center justify-between p-8 mx-auto lg:justify-between xl:px-1">
        ...
        <div className="gap-3 nav__item mr-2 lg:flex ml-auto lg:ml-0 lg:order-2">
            ...
            <div className="hidden mr-3 lg:flex nav__item">
              <Link href="https://wa.me/5493512332525" className="px-6 py-2 text-white bg-indigo-600 rounded-md md:ml-5">
                Consulta Gratuita
              </Link>
            </div>
        </div>
            ...
            <>
                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    ...
                    <Link href="https://wa.me/5493512332525" className="w-full px-6 py-2 mt-3 text-center text-white bg-indigo-600 rounded-md lg:ml-5">         
                        Get Started
                    </Link>
                  </>
                </Disclosure.Panel>
