...
// PRIMERO: Definir todas las funciones de logos ANTES del componente Hero
function OpenAILogo() {
  return (
    <svg
...
// DESPUÉS: El componente Hero que usa las funciones ya definidas
export const Hero = () => {
  return (
    <>
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Transformamos tu empresa con Inteligencia Artificial DE AVANZADA
            </h1>
